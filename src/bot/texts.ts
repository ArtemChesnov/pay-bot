...
/**
 * Промо-приветствие при /start (HTML). Показывается одним блоком с кнопкой «Начать».
 * Юридический экран (политика, оферта) открывается после нажатия кнопки.
 */
export const MSG_WELCOME_PROMO =
  '🔥 <b>Курс «РЕЛЬЕФ» — старт к красивой фигуре, сильным мышцам и дисциплине</b>\n\n' +
  '💔 Продажи на курс уже открыты.\n\n' +
  '<b>Что тебя ждёт:</b>\n' +
  '✔ 28 дней интенсивных тренировок\n' +
  '✔ 28 дней тренировок на «здоровье»\n' +
  '✔ Мобилизация грудного отдела и тазобедренных суставов\n' +
  '✔ Работа с дыханием и МФР всего тела\n' +
  '✔ Чат поддержки\n\n' +
  '<b>Тарифы участия:</b>\n\n' +
  '🟢 <b>Самостоятельный — 4 900 ₽</b>\n' +
  '— доступ ко всем тренировкам на 3 месяца\n' +
  '— чат единомышленников\n' +
  '— поддержка и полезные материалы\n\n' +
  '🔵 <b>Индивидуальный — 11 900 ₽</b>\n' +
  '— доступ ко всем тренировкам на 5 месяцев\n' +
  '— диагностика постуры и движения\n' +
  '— 4 онлайн-тренировки «здоровье»\n' +
  '— индивидуальный чат с Викторией на 2 месяца\n\n' +
  '✨ Нажми «Начать», чтобы перейти к оформлению участия.';

/** @deprecated Используется только в fallback; при /start показывается MSG_WELCOME_PROMO */
