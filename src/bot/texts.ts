...
export const MSG_PAYMENT_ALREADY_ACTIVE =
  "Оплата уже подтверждена ✅ Доступ активирован.\nЕсли не пришла ссылка в учебный чат — напиши сюда, тренер пришлёт.";
...
export const MSG_CONFIRMED_SELF_GROUP_NOT_READY =
  "Оплата подтверждена ✅\n" +
  "Доступ активирован до {EXPIRES_AT}.\n\n" +
  "Общий учебный чат ещё настраивается. Когда будет готов — нажмите «Проверить оплату» в сообщении выше или напишите сюда любое сообщение — пришлю ссылку в чат.";
