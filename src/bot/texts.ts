 ...
 * Старые цены отображаются зачёркнутыми через <s>. Юридический экран открывается после нажатия кнопки.
 */
export const MSG_WELCOME_PROMO =
  "🔥 Курс «РЕЛЬЕФ» — старт к красивой фигуре, сильным мышцам и дисциплине\n\n" +
  "💔 Продажи на курс уже открыты.\n\n" +
  "Что тебя ждёт:\n" +
  "▪️ 28 дней интенсивных тренировок\n" +
  "▪️ 28 дней тренировок на «здоровье»\n" +
  "— мобилизация грудного отдела и тазобедренных суставов\n" +
  "— работа с дыханием и МФР всего тела\n" +
  "▪️ чат поддержки\n\n" +
  "Тарифы участия:\n\n" +
  "🟢 Самостоятельный — 3 900 ₽ <s>4 900 ₽</s>\n\n" +
  "— доступ ко всем тренировкам на 3 месяца\n" +
  "— чат единомышленников, поддержка и полезные материалы на 1 месяц\n\n" +
  "🔵 Индивидуальный — 10 500 ₽ <s>11 900 ₽</s>\n\n" +
...
export const MSG_YOOKASSA_PAY =
  ...
  "После оплаты вернись в этот чат и обязательно нажми кнопку «Проверить оплату» — так бот подтвердит платёж и выдаст доступ по выбранному тарифу. Нажми «Оплатить», чтобы перейти к оплате.";
...
export const MSG_PAYMENT_CHECK_CANCELED =
  ...
  "Можно вернуться к оплате по ссылке выше или оформить новую заявку через /start.";

export const MSG_PAYMENT_CHECK_SUCCESS =
  "Оплата подтверждена ✅\n\n" +
  "Участие в курсе «РЕЛЬЕФ» оформлено. Доступ будет предоставлен по правилам выбранного тарифа.";
...
export const MSG_PAYMENT_ORDER_NOT_FOUND =
  "Эта заявка уже обработана или больше неактуальна.\n\n" +
  "Если хочешь оформить участие, нажми /start и выбери подходящий тариф заново.";

/** Нажатие «Проверить оплату», когда заявка уже активирована (например, по webhook). */
export const MSG_PAYMENT_ALREADY_ACTIVE =
  "Оплата уже подтверждена ✅\n\n" +
  "Доступ по этой заявке уже активирован.\n" +
  "Если ссылка в чат не пришла или потерялась — просто напиши сюда, и я помогу.";
...
export const MSG_CONFIRMED_SELF_GROUP_READY =
  "Оплата подтверждена ✅\n\n" +
  "Тариф «Самостоятельный» успешно оформлен.\n" +
  "Доступ к курсу активирован до {EXPIRES_AT}.\n\n" +
  "Ниже — ссылка для входа в общий чат.\n" +
  "Она действует ограниченное время, поэтому лучше перейти сразу.";

export const MSG_CONFIRMED_SELF_GROUP_NOT_READY =
  "Оплата подтверждена ✅\n\n" +
  "Тариф «Самостоятельный» успешно оформлен.\n" +
  "Доступ к курсу активирован до {EXPIRES_AT}.\n\n" +
  "Общий учебный чат ещё настраивается.\n" +
  "Когда он будет готов, нажми «Проверить оплату» в сообщении выше или просто напиши сюда — я пришлю ссылку.";

export const MSG_CONFIRMED_INDIVIDUAL =
  "Оплата подтверждена ✅\n\n" +
  "Тариф «Индивидуальный» успешно оформлен.\n" +
  "Доступ к курсу активирован до {EXPIRES_AT}.\n\n" +
...
export const MSG_CONFIRMED_INDIVIDUAL_DM =
  ...
  "Тариф «Индивидуальный» успешно оформлен.\n" +
  "Доступ к курсу активирован до {EXPIRES_AT}.\n\n" +
  "Твой тренер: {TRAINER_USERNAME}\n" +
  "Он напишет тебе. Если у тебя закрыты личные сообщения — напиши ему первым.";

export const MSG_CONFIRMED_INDIVIDUAL_DM_NO_USERNAME =
  "Оплата подтверждена ✅\n\n" +
  "Тариф «Индивидуальный» успешно оформлен.\n" +
  "Доступ к курсу активирован до {EXPIRES_AT}.\n\n" +
  "Тренер свяжется с тобой сам. Если личные сообщения закрыты — открой настройки приватности в Telegram.";

export const MSG_CONFIRMED_INDIVIDUAL_GROUP_PENDING =
  "Оплата подтверждена ✅\n\n" +
  "Тариф «Индивидуальный» успешно оформлен.\n" +
  "Тренер создаёт для тебя личный чат. Я пришлю ссылку, как только всё будет готово.";

export const MSG_CONFIRMED_INDIVIDUAL_GROUP_READY =
  "Оплата подтверждена ✅\n\n" +
  "Тариф «Индивидуальный» успешно оформлен.\n" +
  "Доступ к курсу активирован до {EXPIRES_AT}.\n\n" +
  "Ниже — ссылка для входа в личный чат с тренером.\n" +
  "Она действует ограниченное время, поэтому лучше перейти сразу.";
...
export const MSG_EXPIRED_SELF =
  "Срок доступа к курсу завершён.\n\n" +
  "Если хочешь продолжить тренировки, нажми /start и оформи участие заново. Я сразу помогу выбрать тариф.";

export const MSG_EXPIRED_INDIVIDUAL =
  "Срок индивидуального сопровождения завершён.\n\n" +
  "Если хочешь продолжить работу, нажми /start и оформи участие заново. Я помогу всё оформить.";
...
export const MSG_INDIVIDUAL_WRITE_TO_TRAINER =
  "По индивидуальному тарифу общение проходит напрямую с тренером.\n" +
  "{TRAINER_USERNAME}\n" +
  "Ссылка: {TRAINER_LINK}";
